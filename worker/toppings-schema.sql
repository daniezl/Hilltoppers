CREATE TABLE IF NOT EXISTS toppings (
 ...
 hidden INTEGER NOT NULL DEFAULT 0, icon TEXT NOT NULL DEFAULT 'sparkle'
);
...
INSERT INTO toppings (id,name,description,url,image,author_uid,author,graduation_year,created_at,hidden,icon) VALUES (
 'ask-sja', 'Ask SJA', 'Answers about school life, with sources you can check.',
 'https://ask-sja-topping.danielzhang089.workers.dev/',
 'builtin:ask-sja', 'hilltoppers', 'Yaoyu Zhang', 2027, 1789603200000, 0, 'chat'
)
